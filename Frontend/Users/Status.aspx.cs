...
namespace FoodHub.Frontend.Users
{
    public partial class WebForm10 : System.Web.UI.Page
    {
        ...
        protected void Received_Click(object sender, EventArgs e)
        {
            RepeaterItem item = (sender as LinkButton).NamingContainer as RepeaterItem;
            OrderDao cartdetails = new OrderDao();
            cartdetails.Invoice_Number = int.Parse((item.FindControl("Invoice_Number") as Label).Text);
            ...
            if (cartdetails.UpdateDelivery(userId))
            {
