<%@ Page Title="" Language="C#" MasterPageFile="~/Frontend/Users/User.Master" AutoEventWireup="true" CodeBehind="Status.aspx.cs" Inherits="FoodHub.Frontend.Users.WebForm10" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div class="container">
            <h1 class="display-3 mb-3 animated slideInDown">Status</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a class="text-body" href="#">Home</a></li>
                    <li class="breadcrumb-item text-dark active" aria-current="page">Order Status</li>
                </ol>
            </nav>
        </div>
    </div>
                      ...
                      <table class="table table-striped" id="table-1">
                       ...
                       <tbody>
                        ...
                        <ItemTemplate>
                            ...
                            <td>
                                <asp:LinkButton ID="btnReceived" CssClass="btn btn-primary" Visible='<%# Eval("Status").ToString() == "2" ? true : false %>' OnClick="Received_Click" runat="server">Received</asp:LinkButton></td>
                          </tr>
