<%@ Page Title="" Language="C#" MasterPageFile="~/frontend/Frontend.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="FoodHub.frontend.WebForm1" %>
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="assests/img/img/Chicken/1.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <p class="mb-4"> Organic food is best</p>
                    <p><i class="fa fa-check text-primary me-3"></i>food</p>
                    <p><i class="fa fa-check text-primary me-3"></i>table</p>
                    <p><i class="fa fa-check text-primary me-3"></i>aaa</p>
