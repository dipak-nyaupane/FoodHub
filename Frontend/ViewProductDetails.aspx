<%@ Page Title="" Language="C#" MasterPageFile="~/Frontend/Frontend.Master" AutoEventWireup="true" CodeBehind="ViewProductDetails.aspx.cs" Inherits="FoodHub.Frontend.WebForm1" %>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <asp:LinkButton ID="AddToCart" CssClass="btn btn-primary rounded-pill py-3 px-5 mt-3" OnClick="AddCart_Click" OnClientClick="return confirm('Please Sign Up !! To Buy This product!');" runat="server">Add To Cart</asp:LinkButton>
